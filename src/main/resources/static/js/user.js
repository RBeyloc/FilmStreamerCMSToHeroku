...
function deleteUserConfirmed(userUUID) {
    axios.delete('http://https://filmstreamer.herokuapp.com/api/users/deleteUser', {
    ...
    .then(function (response) {
        ...
        document.getElementById('id01').style.display='block';
        document.getElementById('confirm').onclick = function(){ document.getElementById('id01').style.display='none'; location.replace('https://filmstreamercontentmanager.herokuapp.com/users/users');};
    })
